...
router.put("/api/v1/employee/:id/salary",[
    ...
    try{
        ...
        try{
            ...
            const {rows} = await CurrentSalaryRepo.updateWithClient(client,obj.employee_id,obj.salary);
            ...
            return next(new BadRequestError("transaction failed during update salary"));
        }finally{
            client.release();
        }
